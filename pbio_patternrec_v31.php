...
class ExcelRecord
{
	...
	*/
	...
	public function writeExcelSource($ui_ColInit,$ui_RowInit,$ui_SheetName,$ui_FileName,$ui_FileExtension)
	{
		...
		$columnArray2d = array_chunk(array_column($rowArray,'1'),1); //modify array_column column_key to output specified column for 2d array
		...
		$objPHPExcel->getActiveSheet()->fromArray($columnArray1d,NULL,$ui_ColInit.$ui_RowInit);	//1D array	
...
$records->setSearchCriteria("digitalimages/");
