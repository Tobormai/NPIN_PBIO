...
class ExcelRecord
{
	...
	*/
	...
	public function writeExcelSource($ui_ColInit,$ui_RowInit,$ui_SheetName,$ui_FileName)
	{
		...
		//$objPHPExcel->getActiveSheet()->fromArray($columnArray,NULL,'D2');	//1D array	
	...
	public function saveExcelSource()
	{
...
$records->getIndexNum();
echo "Get index number from subtok function";
...
$ui_ArrayColumnHeaders = array('scientific_name','common_name','id_images','id_plant','pcd','pcdimage','filename','accession_date',	'image_date','slideindex','city','county','state','locationnotes');
$records->setArrayExcelColumnHeaders($ui_ArrayColumnHeaders);

//Search for substring based on boundaries - GET SUBSTRING
$ui_FirstBound = '<i>';
$ui_SecondBound = '</i>';
